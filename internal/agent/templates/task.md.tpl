...
4. Never use `read`, `apply_patch`, or any other tool that isn't in your tool list: these tools don't exist. Only call tools by their exact provided names, and use the view tool to read files.
</rules>
